...
import Logo from "../../images/festivalBilling.png";
      ...
      <Grid container sx={{ mt: 4, mb: 8 }}>
        ...
        <Grid lg={6} sm={12} sx={{ px: 3 }}>
          ...
          <Stack direction="column" spacing={1}>
            ...
            <Typography color="#464646"><b>Sat May 20 at 7:00pm</b></Typography>
            <Typography color="#464646">
            <b>Westgate Las Vegas Resort & Casino, Las Vegas, NV</b>
            </Typography>
