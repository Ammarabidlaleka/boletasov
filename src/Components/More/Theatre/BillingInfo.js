...
import Logo from "../../images/theatreBilling.png";
        ...
        <Grid lg={6} sm={12} sx={{ px: 3 }}>
          ...
          <Stack direction="column" spacing={1}>
            <Typography variant="h6">
              <b>Hadestown - Seattle</b>
            </Typography>
            <Typography color="#464646"><b>Fri Nov 3 at 8:00pm</b></Typography>
            <Typography color="#464646">
            <b>Paramount Theatre - WA, Seattle, WA</b>
            </Typography>
            <Stack direction="row" justifyContent="space-between">
              ...
              <b><span style={{ color: "#3E39D1" }}>$48</span>x2</b>
              </Typography>
            </Stack>
          </Stack>
          <br />
